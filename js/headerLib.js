...
$("#mm .item1").on('touchstart click',() => {window.location = 'http://www.cubscoutpack97.org/'});
//bind Program Overview menu buttons
$("#mm .item27").on('touchstart click',() => {window.location = 'http://www.cubscoutpack97.org/index.php?option=com_content&amp;view=article&amp;id=19&amp;Itemid=27'});
//bind Pack menu nCommittee buttons
$("#mm .item58").on('touchstart click',() => {window.location = 'http://www.cubscoutpack97.org/index.php?option=com_contact&amp;view=category&amp;catid=12&amp;Itemid=58'});
//bind Leaders menu buttons
$("#mm .item59").on('touchstart click',() => {window.location = 'http://www.cubscoutpack97.org/index.php?option=com_contact&amp;view=category&amp;catid=37&amp;Itemid=59'});
//bind Resources menu buttons
$("#mm .item66").on('touchstart click',() => {window.location = 'http://www.cubscoutpack97.org/events/events_home.php'});
